...
public class TicketServiceImpl implements TicketService {
    ...
    public void purchaseTickets(Long accountId, TicketTypeRequest... ticketTypeRequests) throws InvalidPurchaseException {
        ...
        validateAdultTickets(groupedTickets.get(ADULT), ticketTypeRequests);
    ...
    private void validateAdultTickets(List<TicketTypeRequest> adults, TicketTypeRequest... ticketTypeRequests) {
        if (adults == null || seatCounter(adults) < 1 || ticketTypeRequests.length > 20) {
