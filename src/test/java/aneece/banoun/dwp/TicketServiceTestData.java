...
public class TicketServiceTestData {
    ...
    public static final Long INVALID_TOO_MANY_TICKETS_ID = 4L;
    ...
    static {
        ...
        List<TicketTypeRequest> invalidBooking3 = new ArrayList<>();
        for (int n = 0; n < 20; n++) {
            invalidBooking3.add(new TicketTypeRequest(ADULT, 2));
            invalidBooking3.add(new TicketTypeRequest(INFANT, 1));
            invalidBooking3.add(new TicketTypeRequest(CHILD, 3));
        }
        ticketServiceTestData.put(INVALID_TOO_MANY_TICKETS_ID, invalidBooking3);
    }
